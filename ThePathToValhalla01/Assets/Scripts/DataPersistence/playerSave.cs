...
public class playerSave : MonoBehaviour, IDataPersistence
{
    ...
    public SimpleEnemy wolf02;
    public SimpleEnemy wolf03;
    public SimpleEnemy wolf04;
    public SimpleEnemy wolf05;
    public SimpleEnemy wolf06;
    public SimpleEnemy wolf07;
    public SimpleEnemy wolf08;
    public SimpleEnemy wolf09;
    public SimpleEnemy wolf10;
    public SimpleEnemy wolf11;
    public SimpleEnemy wolf12;
    public SimpleEnemy wolf13;
    public SimpleEnemy wolf14;
    public SimpleEnemy wolf15;
    public SimpleEnemy wolf16;
    public SimpleEnemy wolf17;
    public SimpleEnemy wolf18;
    public SimpleEnemy wolf19;
    public SimpleEnemy wolf20;
    public SimpleEnemy wolf21;
    public SimpleEnemy wolf22;
    public SimpleEnemy wolf23;
    public SimpleEnemy wolf24;
    public SimpleEnemy wolf25;
    public SimpleEnemy wolf26;
    public SimpleEnemy wolf27;
    public SimpleEnemy wolf28;
    public SimpleEnemy wolf29;
    public SimpleEnemy wolf30;
    public SimpleEnemy wolf31;
    public SimpleEnemy wolf32;
    public SimpleEnemy wolf33;
    public SimpleEnemy wolf34;
    ...
    public void LoadData(GameData data)
    {
        ...
        this.wolf02.isDead = data.isWolf02Dead;
        this.wolf02.transform.position = data.wolf02Position;
        this.wolf03.isDead = data.isWolf03Dead;
        this.wolf03.transform.position = data.wolf03Position;
        this.wolf04.isDead = data.isWolf04Dead;
        this.wolf04.transform.position = data.wolf04Position;
        this.wolf05.isDead = data.isWolf05Dead;
        this.wolf05.transform.position = data.wolf05Position;
        this.wolf06.isDead = data.isWolf06Dead;
        this.wolf06.transform.position = data.wolf06Position;
        this.wolf07.isDead = data.isWolf07Dead;
        this.wolf07.transform.position = data.wolf07Position;
        this.wolf08.isDead = data.isWolf08Dead;
        this.wolf08.transform.position = data.wolf08Position;
        this.wolf09.isDead = data.isWolf09Dead;
        this.wolf09.transform.position = data.wolf09Position;
        this.wolf10.isDead = data.isWolf10Dead;
        this.wolf10.transform.position = data.wolf10Position;
        this.wolf11.isDead = data.isWolf11Dead;
        this.wolf11.transform.position = data.wolf11Position;
        this.wolf12.isDead = data.isWolf12Dead;
        this.wolf12.transform.position = data.wolf12Position;
        this.wolf13.isDead = data.isWolf13Dead;
        this.wolf13.transform.position = data.wolf13Position;
        this.wolf14.isDead = data.isWolf14Dead;
        this.wolf14.transform.position = data.wolf14Position;
        this.wolf15.isDead = data.isWolf15Dead;
        this.wolf15.transform.position = data.wolf15Position;
        this.wolf16.isDead = data.isWolf16Dead;
        this.wolf16.transform.position = data.wolf16Position;
        this.wolf17.isDead = data.isWolf17Dead;
        this.wolf17.transform.position = data.wolf17Position;
        this.wolf18.isDead = data.isWolf18Dead;
        this.wolf18.transform.position = data.wolf18Position;
        this.wolf19.isDead = data.isWolf19Dead;
        this.wolf19.transform.position = data.wolf19Position;
        this.wolf20.isDead = data.isWolf20Dead;
        this.wolf20.transform.position = data.wolf20Position;
        this.wolf21.isDead = data.isWolf21Dead;
        this.wolf21.transform.position = data.wolf21Position;
        this.wolf22.isDead = data.isWolf22Dead;
        this.wolf22.transform.position = data.wolf22Position;
        this.wolf23.isDead = data.isWolf23Dead;
        this.wolf23.transform.position = data.wolf23Position;
        this.wolf24.isDead = data.isWolf24Dead;
        this.wolf24.transform.position = data.wolf24Position;
        this.wolf25.isDead = data.isWolf25Dead;
        this.wolf25.transform.position = data.wolf25Position;
        this.wolf26.isDead = data.isWolf26Dead;
        this.wolf26.transform.position = data.wolf26Position;
        this.wolf27.isDead = data.isWolf27Dead;
        this.wolf27.transform.position = data.wolf27Position;
        this.wolf28.isDead = data.isWolf28Dead;
        this.wolf28.transform.position = data.wolf28Position;
        this.wolf29.isDead = data.isWolf29Dead;
        this.wolf29.transform.position = data.wolf29Position;
        this.wolf30.isDead = data.isWolf30Dead;
        this.wolf30.transform.position = data.wolf30Position;
        this.wolf31.isDead = data.isWolf31Dead;
        this.wolf31.transform.position = data.wolf31Position;
        this.wolf32.isDead = data.isWolf32Dead;
        this.wolf32.transform.position = data.wolf32Position;
        this.wolf33.isDead = data.isWolf33Dead;
        this.wolf33.transform.position = data.wolf33Position;
        this.wolf34.isDead = data.isWolf34Dead;
        this.wolf34.transform.position = data.wolf34Position;
        this.wolf35.isDead = data.isWolf35Dead;
        this.wolf35.transform.position = data.wolf35Position;
    ...
    public void SaveData(GameData data)
    {
        ...
        data.isWolf02Dead = this.wolf02.isDead;
        data.wolf02Position = this.wolf02.transform.position;
        data.isWolf03Dead = this.wolf03.isDead;
        data.wolf03Position = this.wolf03.transform.position;
        data.isWolf04Dead = this.wolf04.isDead;
        data.wolf04Position = this.wolf04.transform.position;
        data.isWolf05Dead = this.wolf05.isDead;
        data.wolf05Position = this.wolf05.transform.position;
        data.isWolf06Dead = this.wolf06.isDead;
        data.wolf06Position = this.wolf06.transform.position;
        data.isWolf07Dead = this.wolf07.isDead;
        data.wolf07Position = this.wolf07.transform.position;
        data.isWolf08Dead = this.wolf08.isDead;
        data.wolf08Position = this.wolf08.transform.position;
        data.isWolf09Dead = this.wolf09.isDead;
        data.wolf09Position = this.wolf09.transform.position;
        data.isWolf10Dead = this.wolf10.isDead;
        data.wolf10Position = this.wolf10.transform.position;
        data.isWolf11Dead = this.wolf11.isDead;
        data.wolf11Position = this.wolf11.transform.position;
        data.isWolf12Dead = this.wolf12.isDead;
        data.wolf12Position = this.wolf12.transform.position;
        data.isWolf13Dead = this.wolf13.isDead;
        data.wolf13Position = this.wolf13.transform.position;
        data.isWolf14Dead = this.wolf14.isDead;
        data.wolf14Position = this.wolf14.transform.position;
        data.isWolf15Dead = this.wolf15.isDead;
        data.wolf15Position = this.wolf15.transform.position;
        data.isWolf16Dead = this.wolf16.isDead;
        data.wolf16Position = this.wolf16.transform.position;
        data.isWolf17Dead = this.wolf17.isDead;
        data.wolf17Position = this.wolf17.transform.position;
        data.isWolf18Dead = this.wolf18.isDead;
        data.wolf18Position = this.wolf18.transform.position;
        data.isWolf19Dead = this.wolf19.isDead;
        data.wolf19Position = this.wolf19.transform.position;
        data.isWolf20Dead = this.wolf20.isDead;
        data.wolf20Position = this.wolf20.transform.position;
        data.isWolf21Dead = this.wolf21.isDead;
        data.wolf21Position = this.wolf21.transform.position;
        data.isWolf22Dead = this.wolf22.isDead;
        data.wolf22Position = this.wolf22.transform.position;
        data.isWolf23Dead = this.wolf23.isDead;
        data.wolf23Position = this.wolf23.transform.position;
        data.isWolf24Dead = this.wolf24.isDead;
        data.wolf24Position = this.wolf24.transform.position;
        data.isWolf25Dead = this.wolf25.isDead;
        data.wolf25Position = this.wolf25.transform.position;
        data.isWolf26Dead = this.wolf26.isDead;
        data.wolf26Position = this.wolf26.transform.position;
        data.isWolf27Dead = this.wolf27.isDead;
        data.wolf27Position = this.wolf27.transform.position;
        data.isWolf28Dead = this.wolf28.isDead;
        data.wolf28Position = this.wolf28.transform.position;
        data.isWolf29Dead = this.wolf29.isDead;
        data.wolf29Position = this.wolf29.transform.position;
        data.isWolf30Dead = this.wolf30.isDead;
        data.wolf30Position = this.wolf30.transform.position;
        data.isWolf31Dead = this.wolf31.isDead;
        data.wolf31Position = this.wolf31.transform.position;
        data.isWolf32Dead = this.wolf32.isDead;
        data.wolf32Position = this.wolf32.transform.position;
        data.isWolf33Dead = this.wolf33.isDead;
        data.wolf33Position = this.wolf33.transform.position;
        data.isWolf34Dead = this.wolf34.isDead;
        data.wolf34Position = this.wolf34.transform.position;
        data.isWolf35Dead = this.wolf35.isDead;
        data.wolf35Position = this.wolf35.transform.position;
